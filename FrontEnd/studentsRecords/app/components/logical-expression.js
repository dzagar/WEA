    ...
    actions: {
        ...
        createLogExp: function(){
            ...
            if (child){
                ...
                if (parent){
                    //parent.set('logicalExpressions', self.get('logicalExpressionsArr'));
                    this.get('store').findRecord('logical-expression', this.get('objectID'), {reload: true})
                    .then(obj => {
                        obj.get('logicalExpressions').pushObject(child);
                    ...
                    // parent.get('logicalExpressions').pushObject(child);
                    // console.log(parent.get('logicalExpressions').get('firstObject'));
                    // console.log(parent.get('id'));
                    // parent.save().then(function(){
                    //     console.log(parent.get('logicalExpressions').get('length'));
                    //     console.log(parent.get('id'));
                    //     self.set('currentChildID', null);
                    //     self.set('creatingNewLogExp', false);
                    // });
        ...
        destroyLogExp: function(logExpObj){
            ...
            var parent = this.get('store').peekRecord('logical-expression', this.get('objectID'));
            if (parent){
                parent.set('logicalExpressions', this.get('logicalExpressionsArr'));
                parent.save();
            } else {
                this.get('store').findRecord('logical-expression', this.get('objectID'), {reload: true})
                .then(obj => {
                    obj.set('logicalExpressions', self.get('logicalExpressionsArr'));
                    obj.save();
                });
            }
            //destroy in backend
